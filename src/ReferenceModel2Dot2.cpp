...
CCI_XPuckProximitySensor::TReadings ReferenceModel2Dot2::GetProximityInput() const {
...
void ReferenceModel2Dot2::SetProximityInput(CCI_XPuckProximitySensor::TReadings s_prox_input) {
...
CCI_XPuckLightSensor::TReadings ReferenceModel2Dot2::GetLightInput() const{
...
void ReferenceModel2Dot2::SetLightInput(CCI_XPuckLightSensor::TReadings s_light_input) {
...
CCI_XPuckGroundSensor::SReadings ReferenceModel2Dot2::GetGroundInput() {
...
void ReferenceModel2Dot2::SetGroundInput(CCI_XPuckGroundSensor::SReadings s_ground_input) {
...
CCI_XPuckRangeAndBearingSensor::SReceivedPacket ReferenceModel2Dot2::GetAttractionVectorToNeighbors(Real f_alpha_parameter) {
...
CCI_XPuckRangeAndBearingSensor::SReceivedPacket ReferenceModel2Dot2::GetAttractionVectorToMessagingNeighbors(Real f_alpha_parameter, UInt8 un_message) {
    CCI_XPuckRangeAndBearingSensor::TPackets sRabPackets = m_pcRabMessageBuffer.GetMessages();
    CCI_XPuckRangeAndBearingSensor::TPackets::iterator it;
    CVector2 sRabVectorSum(0,CRadians::ZERO);
...
std::vector<CCI_XPuckRangeAndBearingSensor::SReceivedPacket*> ReferenceModel2Dot2::GetRangeAndBearingMessages() {
...
void ReferenceModel2Dot2::SetRangeAndBearingMessages(CCI_XPuckRangeAndBearingSensor::TPackets s_packets) {
